...
celdas = []
celdas.append(nbf.v4.new_markdown_cell("""# Análisis Exploratorio y Preprocesamiento de Datos (Dual-Engine V2 - Factores Humanos)
...
---"""))
celdas.append(nbf.v4.new_code_cell("""import pandas as pd
import json
...
plt.tight_layout()
plt.show()"""))
celdas.append(nbf.v4.new_markdown_cell("""### Análisis: Desbalance de Fuentes y Sesgo de Cobertura
...
celdas.append(nbf.v4.new_code_cell("""# Análisis de Longitud (Caracteres) de los fragmentos
...
plt.tight_layout()
plt.show()"""))
celdas.append(nbf.v4.new_markdown_cell("""### Análisis: Estrategia de Fragmentación y Profundidad de Respuesta
...
celdas.append(nbf.v4.new_code_cell("""from wordcloud import WordCloud
import nltk
...
plt.show()"""))
celdas.append(nbf.v4.new_markdown_cell("""### Análisis Semántico: Sesgo en la Nube de Palabras
...
celdas.append(nbf.v4.new_code_cell("""import numpy as np
import umap
...
plt.tight_layout()
plt.show()"""))
celdas.append(nbf.v4.new_markdown_cell("""### Análisis Topológico: Separación Semántica Parcial
...
celdas.append(nbf.v4.new_markdown_cell("""### Justificación Técnica: Limpieza de Metadata y Prevención de Sesgos
...
celdas.append(nbf.v4.new_markdown_cell("""### Justificación Técnica: Supuestos de K-NN y Escalamiento
...
celdas.append(nbf.v4.new_markdown_cell("""### Análisis de Correlación: Hallazgos Aeronáuticos
...
print("¡Notebook 'EDA_Avanzado_DualEngine_CCHS.ipynb' generado exitosamente replicando al 100% el respaldo raíz!")
